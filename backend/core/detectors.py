...
def suggest_merge_candidates(df: pd.DataFrame) -> dict:
    """
    Suggest likely "title/description" and "finish/colour" columns
    and provide ready-to-use merge_template strings.
    """
    ...
    for c in cols:
        ...
        # Boost common description keywords
